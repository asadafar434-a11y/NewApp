...
const QUICK_ACTIONS = [
  {
    icon: Users,
    label: "Нанять сотрудника",
    sub: "5 кандидатов ждут",
    color: "#5b6ef5",
    to: "/hiring",
  },
  {
  ...
  },
  {
    ...
    sub: "ROAS 2.8× — ниже цели",
    color: "#7c3aed",
    to: "/marketing",
  },
  {
    icon: Activity,
    label: "Операционный отчёт",
    sub: "Новый KPI-дайджест",
    color: "#10b981",
    to: "/operations",
  },
];
...
const TASKS = [
  {
    id: 1,
    title: "Поиск UX-дизайнера",
    section: "Найм",
    status: "done",
    result: "5 кандидатов найдено",
    time: "2 часа назад",
    color: "#5b6ef5",
    to: "/hiring",
  },
  {
    id: 2,
    title: "Анализ падения выручки Q3",
    section: "Финансы",
    status: "done",
    result: "3 точки потерь выявлено",
    time: "5 часов назад",
    color: "#ef4444",
    to: "/finance",
  },
  ...
  {
    id: 4,
    title: "Еженедельный KPI-дайджест",
    section: "Операции",
    status: "done",
    result: "Отчёт за неделю готов",
    time: "Вчера",
    color: "#10b981",
    to: "/operations",
  },
...
const NOTIFICATIONS = [
  {
    id: 1,
    icon: Users,
    text: "Анна Ковалёва ответила на ваше сообщение",
    time: "10 мин",
    color: "#5b6ef5",
    unread: true,
    to: "/messages",
  },
  {
    id: 2,
    icon: Calendar,
    text: "Созвон с Марией Смирновой через 2 дня",
    time: "1 ч",
    color: "#f59e0b",
    unread: true,
    to: "/hiring",
  },
  {
    id: 3,
    icon: TrendingDown,
    text: "Финансовый отчёт готов — найдено 3 проблемы",
    time: "3 ч",
    color: "#ef4444",
    unread: true,
    to: "/finance",
  },
  {
    id: 4,
    icon: Activity,
    text: 'Задача "Сверка данных" завершилась с ошибкой',
    time: "5 ч",
    color: "#ef4444",
    unread: true,
    to: "/operations",
  },
  {
    id: 5,
    icon: CheckCircle2,
    text: "KPI-дайджест за неделю сформирован",
    time: "Вчера",
    color: "#10b981",
    unread: false,
    to: "/operations",
...
const STATS = [
  ...
  {
    value: "6.2ч",
    label: "Сэкономлено сегодня",
    delta: "vs ручная работа",
    up: true,
    icon: Clock,
  },
  {
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              border: `1px solid ${
                showNotifications ? "var(--color-border-strong)" : "var(--color-border-default)"
              }`,
              borderRadius: "var(--radius-md)",
              padding: "var(--space-3)",
              cursor: "pointer",
              ...
              alignItems: "center",
              justifyContent: "center",
              color: showNotifications ? "var(--color-accent-primary)" : "var(--color-text-muted)",
                ...
                {s.up !== null && (
                  <span
                    style={{
                      fontFamily: "var(--font-mono)",
                      fontSize: 10,
                      color: s.up ? "var(--color-accent-success)" : "var(--color-text-muted)",
                      background: s.up ? "rgba(16,185,129,0.1)" : "var(--color-bg-elevated)",
                      borderRadius: "var(--radius-full)",
                      padding: "2px 7px",
                    }}
                  >
            ...
            {activeTasks.map((task, i) => (
              <div
                ...
                style={{
                  ...
                  padding: "var(--space-4) var(--space-5)",
                  borderBottom:
                    i < activeTasks.length - 1 ? "1px solid var(--color-border-subtle)" : "none",
                  cursor: "pointer",
                  transition: "background var(--duration-fast)",
                }}
              ...
              >
                <div
                  style={{
                    ...
                    flexShrink: 0,
                    boxShadow: task.status === "running" ? `0 0 8px ${task.color}` : "none",
                    animation:
                      task.status === "running" ? "pulse 1.5s ease-in-out infinite" : "none",
                  }}
                />
